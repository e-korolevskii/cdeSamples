...
{
    [DeviceType(DeviceType = eCDMyTestPluginDeviceTypes.cdeThingDeviceTypeA, Description = "This Thing does...", Capabilities = new[] { eThingCaps.ConfigManagement })]
    class cdeThingDeviceTypeA : TheThingBase
    {
        ...
        public cdeThingDeviceTypeA(TheThing tBaseThing, ICDEPlugin pPluginBase)
        {
            ...
            //TODO: Add your DeviceType to the plug-in's eCDMyTestPluginDeviceTypes class
            MyBaseThing.DeviceType = eCDMyTestPluginDeviceTypes.cdeThingDeviceTypeA;
        }
