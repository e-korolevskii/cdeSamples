    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            TheBaseAssets.MyServiceHostInfo = new TheServiceHostInfo(cdeHostType.Application)
            {
                ...
                MyStationPort = 8702,        // Port for REST access to this node. 
                ...
                MyStationWSPort = 8702,      // Enables WebSockets on the station port. 
                ...
                ISMMainExecutable = "cdeMiniNode",                   // Name of the executable (without .exe)
                ...
                ServiceRoute = "wss://cloud.c-labs.com" // localhost:8700"
            };
