    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            TheBaseAssets.MyServiceHostInfo = new TheServiceHostInfo(cdeHostType.Application)
            {
                ...
                cdeMID = TheCommonUtils.CGuid("{D2329D14-F482-437D-91BF-2808D4F95BD2}"),
                ...
                MyStationWSPort = 8700,      // Enables WebSockets on the station port. 
                ...
                ISMMainExecutable = "cdeHostNetCore",                   // Name of the executable (without .exe)
            ...
            strScope = "12344321";// TheScopeManager.GenerateNewScopeID();     // TIP: instead of creating a new random ID every 
