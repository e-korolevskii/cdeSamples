    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            TheBaseAssets.MyServiceHostInfo = new TheServiceHostInfo(cdeHostType.Application)
            {
                ...
                cdeMID = TheCommonUtils.CGuid("6f501ab2-3acb-45ce-a67e-280bd0a49099"),
                ...
                ISMMainExecutable = "myHelloWorldHost",                   // Name of the executable (without .exe)
            ...
            strScope = "123"; // TheScopeManager.GenerateNewScopeID();     // TIP: instead of creating a new random ID every 
